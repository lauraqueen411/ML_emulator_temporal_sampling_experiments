...
# Define arrays
ml_models=("pr_ACCESS-CM2_1961-1980" "pr_ACCESS-CM2_2015-2034" "pr_ACCESS-CM2_2080-2099")
#"pr_ACCESS-CM2_5" "pr_ACCESS-CM2_10" "pr_ACCESS-CM2_20" "pr_ACCESS-CM2_30" "pr_ACCESS-CM2_40" "pr_ACCESS-CM2_5" "pr_ACCESS-CM2_50" "pr_ACCESS-CM2_60" "pr_ACCESS-CM2_70" "pr_ACCESS-CM2_80" "pr_ACCESS-CM2_90" "pr_ACCESS-CM2_100")
...
for ml_model in "${ml_models[@]}"; do
    ...
    for i in "${!gcms[@]}"; do
      ...
      sbatch -J "${ml_model}_${gcm}" apply_emulator_mahu.sl "${ssp}" "${gcm}" "${variant}" "${variable}" "${ml_model}" "${gan}"
